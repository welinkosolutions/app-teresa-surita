...
/**
 * ======================================================
 * CAMINHO: /home/elab/app.elab.social/api/feed/todos.php
 * NOME: API Feed Comunidade V2 — Todos
 *
 * DESCRIÇÃO:
 * - Retorna feed geral da Comunidade em JSON
 * - Fonte: vw_comunidade_feed_unificado
 * - Inclui game_eventos, metaverso_posts e social_events de usuários elab
...
$params[':cursor_origem_id'] = $cursorOrigemId;
    ...
    feedJson([
        'ok' => false,
        'erro' => 'erro_feed_todos',
        'mensagem' => 'Não foi possível carregar o feed agora.',
    ], 500);
}